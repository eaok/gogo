...
type Student struct {
	Age       uint   `orm:"column(age)" description:"age"`
	Firstname string `orm:"column(firstname);size(10)" description:"firstname"`
	Lastname  string `orm:"column(lastname);size(10)" description:"lastname"`
	Id        int    `orm:"column(student_id);auto" description:"student_id"`
}
